...
export default function ProjectKvLayout ({ kv_column_direction, nameEN, nameCN, nameJP, type, roles, date, tool, bannerImg, bannerImgPosition, url, urlTitle, urlNeed, comment}){
