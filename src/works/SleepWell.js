      ...
      <PageLayout>
        <section id={sleepCss.works_sleep}>
          <Sidebar sidebarTitle="Explore this page" emoji_1="⬇️" emoji_1_text="Scroll" emoji_2="👀"
                   emoji_2_text="View" marginTopSetting="2rem" colorEmoji="#945D00" />
          <div className={sleepCss.kv_container}>
            ...
            <div className={sleepCss.paragraph_1_container}
              ...
              <div className={sleepCss.paragraph_1_description_container}>
                <div className={sleepCss.paragraph_1_description_prop}>SLEEP
                  WELLは名前の通り、より良い睡眠を取るためにお手伝いする睡眠管理アプリです。
                </div>
                <div
                  className={sleepCss.paragraph_1_description_prop}>現行他社のアプリですでに提供されているアラーム、データ分析、睡眠サポート、カスタマイズ設定以外、朝活任務、睡眠日記、テーマ変更など、実用かつ面白みのある機能を加えることで、アプリの使用意欲を高め、より良い睡眠を取れることに繋がります。
                </div>
              </div>
            </div>
            ...
            <div className={sleepCss.reason_container}>
              <div className={sleepCss.reason_contents_container}
                ...
                <div className={sleepCss.reason_contents_each_container}>
                  ...
                  <div className={sleepCss.reason_description_container}>
                    <div className={sleepCss.reason_description_prop}>◆15~25歳の学生</div>
            ...
            <div className={sleepCss.paragraph_1_container}
              ...
              <div className={sleepCss.paragraph_1_description_container}>
                <div className={sleepCss.paragraph_1_description_prop}>現行アプリの機能統合はSLEEP WELLの大きな特徴です。
                </div>
                <div className={sleepCss.paragraph_1_description_prop}>◆寝つきが悪い</div>
                <div
                  className={sleepCss.paragraph_1_description_prop}>睡眠日記で気持ちを整理したり、ホワイトノイズの曲で心をリラックスしたり、眠りにつきやすい状態になることを手伝う機能を充実します。
                </div>
                <div className={sleepCss.paragraph_1_description_prop}>◆寝る時間が足りない</div>
                <div
                  className={sleepCss.paragraph_1_description_prop}>睡眠時間を把握やすいため、毎日の睡眠状況を記録し、睡眠時間は6時間未満だとリマインドの通知が来るようにします。
                </div>
                <div className={sleepCss.paragraph_1_description_prop}>◆良い睡眠習慣をつけたい</div>
                <div
                  className={sleepCss.paragraph_1_description_prop}>睡眠状況を可視化する以外、朝活任務の機能で任務を設定し、達成したらインセンティブとしてテーマの購入で使えるポイントを配布することで、早寝早起きの動機づけを高めます。
                </div>
              </div>
            </div>
                ...
                <div className={sleepCss.show_contents_container}>
                  ...
                  <div className={sleepCss.show_description_container}>
                    ...
                    <div className={sleepCss.show_description_contents_container}>
                      <div
                        className={sleepCss.show_description_contents_prop}>就寝・睡眠時間、浅い眠りと深い眠りの割合を詳しく記録し、図で表現します。
                      </div>
                      <div
                        className={sleepCss.show_description_contents_prop}>睡眠時間のデータに基づき、睡眠効率を算出し、睡眠の質を可視化します。
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className={sleepCss.show_container}
                ...
                <div className={sleepCss.show_contents_container}>
                  ...
                  <div className={sleepCss.show_description_container}>
                    ...
                    <div className={sleepCss.show_description_contents_container}>
                      <div
                        className={sleepCss.show_description_contents_prop}>音と振動で、睡眠段階を判断し、浅い眠りの時間帯にアラームを起動させることで、ストレスフリーの起床を実現します。
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className={sleepCss.show_container}
                ...
                <div className={sleepCss.show_contents_container}>
                  ...
                  <div className={sleepCss.show_description_container}>
                    ...
                    <div className={sleepCss.show_description_contents_container}>
                      <div
                        className={sleepCss.show_description_contents_prop}>朝ご飯を作る、ランニングなど、朝活任務を設定し、達成したらポイントが貯まるシステムで、早寝早起きの意欲を高める効果を狙います。
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className={sleepCss.paragraph_1_container}
              ...
              <div className={sleepCss.paragraph_1_description_container}>
                <div
                  className={sleepCss.paragraph_1_description_prop}>ユーザーが寝る前にお部屋で睡眠アプリを開く使用シーンを想定し、ベッドライトで照らした少し暗めの空間でも目の負担をかけないように、暗めの紫をメインカラーとして使用しました。
                </div>
                <div
                  className={sleepCss.paragraph_1_description_prop}>紫は冷静、落ち着く、リラックスのイメージがあり、良い睡眠に繋がる効果があると考えられます。
                </div>
              </div>
            ...
            <div className={sleepCss.prototype_container}>
              <div className={sleepCss.prototype_contents_container}
                ...
                <iframe id="prototype_sleep_well_iframe_content"
                        width="375" height="667"
                        src="https://xd.adobe.com/embed/f19f85da-a465-45f3-888d-9b6de362fce5-a4cc/"
            ...
            <div className={sleepCss.postscript_container}>
              <div className={sleepCss.postscript_contents_container}
                ...
                <div className={sleepCss.postscript_paragraph_container}>
                  <div className={sleepCss.postscript_paragraph_prop}>「SLEEP WELL」は授業の課題で制作した作品ですが、Case
                    studyをはじめ、Functional map、UI flow、Flow
                    chatで情報アーキテクチャを整理し、ワイヤーフレームとモックアップを通してデザインを作り、最後はプロトタイプを使用し、ターゲットユーザーにテストを実施しました。
                  </div>
                  <div
                    className={sleepCss.postscript_paragraph_prop}>こうして一連のデザインプロセスをしっかり行い、試行錯誤しながら制作することが私にとってとても貴重な経験であり、サービスデザインの深さと面白さを感じるきっかけになりました。
                  </div>
                  <div
                    className={sleepCss.postscript_paragraph_prop}>健康と睡眠に意識を向けるつもりなのに、課題や趣味、つい他のことを優先して、睡眠の質が二の次になってしまいます。私たちが抱えた悩みをもとに、同世代の方の共通課題を洗い出し、それをテーマにして、サービスを作りました。
                  </div>
                </div>
