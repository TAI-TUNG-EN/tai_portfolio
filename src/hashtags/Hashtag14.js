...
export default function Hashtag1() {
  ...
  return(
    <>
      <HashtagTemplate 
        title="被写体にもなれる"
        description={["こう見えて、実は小さい頃の夢はモデルになることでした。", "しかし、そんな願いを叶えずに、鏡に映っている現実を見ながらそのまま大人になりました。", "それでも、心の中にモデル魂まだ残っていたようで、大学時代からカメラを練習している友達の被写体になったり、今もたまに写真を撮ってもらっています。"]}
        mainImg={ mainImg }
        prevImg={ prevImg }
        prevImgPosition="center"
        nextImg={ nextImg }
        nextImgPosition="top"
        currentIndex="hashtag_14"
